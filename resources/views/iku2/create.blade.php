...
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Tambah IKU 2</title>@vite(['resources/css/app.css', 'resources/js/app.js'])
    ...
    <x-user-layout activeIku="IKU 2">
        ...
        <div class="py-6 max-w-4xl mx-auto" x-data="formIku2()">
            <form action="{{ route('user.iku2.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm p-6 space-y-6" data-aos="fade-up" onsubmit="confirmSubmit(event, 'Apakah Anda yakin ingin menyimpan data ini?')">
                ...
                <div class="border-b pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-blue-50 p-4 rounded-lg">
                            ...
                            <input type="number" name="bekerja_bobot_1_0" x-model.number="bekerja1_0" class="w-full rounded-lg border-blue-200" min="0" value="0">
                        </div>
                        <div class="bg-cyan-50 p-4 rounded-lg">
                            ...
                            <input type="number" name="bekerja_bobot_0_8" x-model.number="bekerja0_8" class="w-full rounded-lg border-cyan-200" min="0" value="0">
                        </div>
                        <div class="bg-indigo-50 p-4 rounded-lg">
                            ...
                            <input type="number" name="bekerja_bobot_0_6" x-model.number="bekerja0_6" class="w-full rounded-lg border-indigo-200" min="0" value="0">
                        </div>
                    </div>
                </div>
                ...
                <div class="border-b pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div class="bg-emerald-50 p-4 rounded-lg">
                            ...
                            <input type="number" name="studi_lanjut" x-model.number="studiLanjut" class="w-full rounded-lg border-emerald-200" min="0" value="0">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                        <div class="bg-amber-50 p-3 rounded-lg">
                            ...
                            <input type="number" name="wirausaha_founder_1_2" x-model.number="f1_2" class="w-full rounded-lg border-amber-200 text-sm mt-1" min="0" value="0">
                        </div>
                        <div class="bg-amber-50 p-3 rounded-lg">
                            <label class="block text-xs font-medium text-amber-700 mb-1">&gt;6 bln &gt;1.2 UMP</label>
                            <span class="text-[10px] text-amber-600">Bobot: 1.0</span>
                            <input type="number" name="wirausaha_founder_1_0" x-model.number="f1_0" class="w-full rounded-lg border-amber-200 text-sm mt-1" min="0" value="0">
                        </div>
                        <div class="bg-amber-50 p-3 rounded-lg">
                            <label class="block text-xs font-medium text-amber-700 mb-1">&lt;6 bln &lt;1.2 UMP</label>
                            <span class="text-[10px] text-amber-600">Bobot: 0.8</span>
                            <input type="number" name="wirausaha_founder_0_8" x-model.number="f0_8" class="w-full rounded-lg border-amber-200 text-sm mt-1" min="0" value="0">
                        </div>
                        <div class="bg-amber-50 p-3 rounded-lg">
                            <label class="block text-xs font-medium text-amber-700 mb-1">&gt;6 bln &lt;1.2 UMP</label>
                            <span class="text-[10px] text-amber-600">Bobot: 0.6</span>
                            <input type="number" name="wirausaha_founder_0_6" x-model.number="f0_6" class="w-full rounded-lg border-amber-200 text-sm mt-1" min="0" value="0">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div class="bg-orange-50 p-3 rounded-lg">
                            ...
                            <input type="number" name="wirausaha_freelancer_0_5" x-model.number="fr0_5" class="w-full rounded-lg border-orange-200 text-sm mt-1" min="0" value="0">
                        </div>
                        <div class="bg-orange-50 p-3 rounded-lg">
                            <label class="block text-xs font-medium text-orange-700 mb-1">&gt;6 bln &gt;1.2 UMP</label>
                            <span class="text-[10px] text-orange-600">Bobot: 0.4</span>
                            <input type="number" name="wirausaha_freelancer_0_4" x-model.number="fr0_4" class="w-full rounded-lg border-orange-200 text-sm mt-1" min="0" value="0">
                        </div>
                        <div class="bg-orange-50 p-3 rounded-lg">
                            <label class="block text-xs font-medium text-orange-700 mb-1">&lt;6 bln &lt;1.2 UMP</label>
                            <span class="text-[10px] text-orange-600">Bobot: 0.3</span>
                            <input type="number" name="wirausaha_freelancer_0_3" x-model.number="fr0_3" class="w-full rounded-lg border-orange-200 text-sm mt-1" min="0" value="0">
                        </div>
                        <div class="bg-orange-50 p-3 rounded-lg">
                            <label class="block text-xs font-medium text-orange-700 mb-1">&gt;6 bln &lt;1.2 UMP</label>
                            <span class="text-[10px] text-orange-600">Bobot: 0.2</span>
                            <input type="number" name="wirausaha_freelancer_0_2" x-model.number="fr0_2" class="w-full rounded-lg border-orange-200 text-sm mt-1" min="0" value="0">
                        </div>
                    </div>
                </div>
                ...
                @include("partials.lampiran-upload", ["ikuNumber" => 2])
        ...
        <script>
            function formIku2() {
                return {
                    ...
                    f1_2: {{ old('wirausaha_founder_1_2', 0) }},
                    f1_0: {{ old('wirausaha_founder_1_0', 0) }},
                    f0_8: {{ old('wirausaha_founder_0_8', 0) }},
                    f0_6: {{ old('wirausaha_founder_0_6', 0) }},
                    fr0_5: {{ old('wirausaha_freelancer_0_5', 0) }},
