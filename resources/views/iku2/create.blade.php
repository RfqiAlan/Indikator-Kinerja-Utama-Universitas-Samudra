                ...
                <div class="border-b pb-6">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center gap-4">
                            <input type="number" name="total_responden" x-model.number="totalResponden" class="w-full md:w-1/3 rounded-lg border-slate-300 focus:ring-blue-500" required min="0">
                            <template x-if="totalLulusan > 0">
                                <span class="text-xs font-medium" :class="totalResponden >= (totalLulusan * 0.75) ? 'text-blue-600' : 'text-rose-600'" x-text="((totalResponden / totalLulusan) * 100).toFixed(1) + '% dari lulusan'"></span>
                            </template>
                        </div>
                ...
                <div class="border-b pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-blue-50 p-4 rounded-lg">
                            <label class="block text-sm font-medium text-blue-700 mb-1">&lt;6 bulan, Gaji &gt;1.2 UMP</label>
                            <p class="text-xs text-blue-600 mb-2">Bobot: 10</p>
                            <input type="number" name="bekerja_bobot_10" x-model.number="bekerja10" class="w-full rounded-lg border-blue-200" min="0" value="0">
                        </div>
                        ...
                        <div class="bg-indigo-50 p-4 rounded-lg">
                            <label class="block text-sm font-medium text-indigo-700 mb-1">&lt;1 tahun, Gaji &lt;1.2 UMP</label>
                            <p class="text-xs text-indigo-600 mb-2">Bobot: 4</p>
                            <input type="number" name="bekerja_bobot_4" x-model.number="bekerja4" class="w-full rounded-lg border-indigo-200" min="0" value="0">
                        </div>
                    </div>
                </div>
