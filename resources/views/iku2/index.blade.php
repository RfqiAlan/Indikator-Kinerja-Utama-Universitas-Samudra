    ...
    <x-user-layout activeIku="IKU 2">
        <x-slot name="header">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-slate-800 dark:text-slate-100">IKU 2: Lulusan Bekerja/Studi/Wirausaha</h2>
                    <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Persentase lulusan produktif dalam 12 bulan setelah kelulusan.</p>
                </div>
        ...
        <div class="py-6 space-y-6">
            ...
            <div x-data="{ open: false }" class="bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-700/50 rounded-2xl">
                ...
                <div x-show="open" x-collapse class="px-6 pb-4 text-sm text-cyan-700 dark:text-cyan-300">
                    <p class="font-mono bg-white dark:bg-slate-800 p-3 rounded-lg mb-3">IKU2 = (A + B + C) / Total Lulusan × 100%</p>
