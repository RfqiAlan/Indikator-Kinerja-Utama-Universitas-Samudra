...
<div class="min-h-screen flex bg-white">
    <!-- Sidebar -->
    <aside class="w-72 bg-white shadow-lg border-r border-blue-100 flex-shrink-0">
            ...
            <div class="px-6 py-4 border-b border-blue-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-xs text-slate-500">Operator Data</p>
                    </div>
                </div>
            </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <!-- Top Bar -->
        <header class="h-16 bg-white shadow-sm border-b border-blue-100 flex items-center justify-between px-6">
            <div>
                {{ $header ?? '' }}
            </div>
