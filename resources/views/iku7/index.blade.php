    ...
    <x-user-layout activeIku="IKU 7">
        <x-slot name="header">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-slate-800 dark:text-slate-100 tracking-tight antialiased">IKU 7: Keterlibatan SDGs</h2>
                    <p class="text-sm font-medium text-slate-600 dark:text-slate-400 mt-1 antialiased">Program yang mendukung SDGs 1, 4, 17 dan pilihan lainnya.</p>
                </div>
