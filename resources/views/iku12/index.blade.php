        ...
        <x-slot name="header">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full">
                ...
                <div class="flex items-center gap-3">
                    <form method="GET" action="{{ route('user.iku12.index') }}" class="flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <form action="{{ route('user.iku12.destroy', $data->id) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini? Semua file lampiran juga akan terhapus.');">
                            @csrf
                            @method('DELETE')
