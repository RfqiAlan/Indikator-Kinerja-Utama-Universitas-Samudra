    ...
    <x-user-layout activeIku="IKU 9">
        <x-slot name="header">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 class="text-xl font-bold text-emerald-700 dark:text-emerald-700 tracking-tight">IKU 9: Pendapatan Non-UKT</h2>
                    <p class="text-sm font-medium text-emerald-600/70 dark:text-emerald-500/80 mt-1">Hibah riset, konsultasi, unit bisnis, royalti, inkubator.</p>
                </div>
        ...
        <div class="py-6 space-y-6" data-aos="fade-up">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border overflow-hidden">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-700/50">
                            ...
                            <tr class="group hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $item->persentase_iku9 >= 20 ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/50 dark:text-emerald-300' : 'bg-rose-100 text-rose-800 dark:bg-rose-900/50 dark:text-rose-300' }}">
                ...
                <div class="px-6 py-12 text-center">
                    ...
                    <a href="{{ route('user.iku9.create') }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 shadow-sm transition-all">
