                ...
                <div class="border-b pb-6">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center gap-4">
                            <input type="number" name="total_responden" x-model.number="totalResponden" value="{{ old('total_responden', 0) }}" class="w-full md:w-1/3 rounded-lg border-slate-300 focus:ring-blue-500" required min="0">
                            <template x-if="totalMahasiswa > 0">
                                <span class="text-xs font-medium" :class="totalResponden >= (totalMahasiswa * 0.75) ? 'text-blue-600' : 'text-rose-600'" x-text="((totalResponden / totalMahasiswa) * 100).toFixed(1) + '% dari mahasiswa'"></span>
                            </template>
                        </div>
