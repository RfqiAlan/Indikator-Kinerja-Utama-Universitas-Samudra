        ...
        <script>
            function formIku3() {
                return {
                    ...
                    mg_k5: {{ old('magang_kurang_5', $iku3->magang_kurang_5 ?? 0) }}, mg_6_10: {{ old('magang_6_10', $iku3->magang_6_10 ?? 0) }}, mg_l10: {{ old('magang_lebih_10', $iku3->magang_lebih_10 ?? 0) }},
                    rs_k5: {{ old('riset_kurang_5', $iku3->riset_kurang_5 ?? 0) }}, rs_6_10: {{ old('riset_6_10', $iku3->riset_6_10 ?? 0) }}, rs_l10: {{ old('riset_lebih_10', $iku3->riset_lebih_10 ?? 0) }},
                    pt_k5: {{ old('pertukaran_kurang_5', $iku3->pertukaran_kurang_5 ?? 0) }}, pt_6_10: {{ old('pertukaran_6_10', $iku3->pertukaran_6_10 ?? 0) }}, pt_l10: {{ old('pertukaran_lebih_10', $iku3->pertukaran_lebih_10 ?? 0) }},
                    kn_k5: {{ old('kkn_kurang_5', $iku3->kkn_kurang_5 ?? 0) }}, kn_6_10: {{ old('kkn_6_10', $iku3->kkn_6_10 ?? 0) }}, kn_l10: {{ old('kkn_lebih_10', $iku3->kkn_lebih_10 ?? 0) }},
                    
                    l_int_j1: {{ old('lomba_int_juara1', $iku3->lomba_int_juara1 ?? 0) }},
                    l_int_j23: {{ old('lomba_int_juara23', $iku3->lomba_int_juara23 ?? 0) }},
                    l_int_harapan: {{ old('lomba_int_harapan', $iku3->lomba_int_harapan ?? 0) }},
                    l_int_finalis: {{ old('lomba_int_finalis', $iku3->lomba_int_finalis ?? 0) }},
                    
                    l_nas_j1: {{ old('lomba_nas_juara1', $iku3->lomba_nas_juara1 ?? 0) }},
                    l_nas_j23: {{ old('lomba_nas_juara23', $iku3->lomba_nas_juara23 ?? 0) }},
                    l_nas_harapan: {{ old('lomba_nas_harapan', $iku3->lomba_nas_harapan ?? 0) }},
                    l_nas_finalis: {{ old('lomba_nas_finalis', $iku3->lomba_nas_finalis ?? 0) }},
                    
                    l_prov_j1: {{ old('lomba_prov_juara1', $iku3->lomba_prov_juara1 ?? 0) }},
                    l_prov_j23: {{ old('lomba_prov_juara23', $iku3->lomba_prov_juara23 ?? 0) }},
                    l_prov_harapan: {{ old('lomba_prov_harapan', $iku3->lomba_prov_harapan ?? 0) }},
                    l_prov_finalis: {{ old('lomba_prov_finalis', $iku3->lomba_prov_finalis ?? 0) }},
