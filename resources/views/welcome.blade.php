...
<body class="antialiased text-slate-800 bg-slate-50 selection:bg-blue-500 selection:text-white min-h-screen flex flex-col items-center justify-center border-t-4 border-blue-500 hero-pattern relative overflow-hidden">
    ...
    <div class="blob bg-indigo-200 w-96 h-96 rounded-full bottom-[-10%] right-[-10%]"></div>
    ...
    <main class="relative z-10 w-full max-w-6xl px-6 lg:px-8 py-12 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        ...
        <div class="flex-1 text-center lg:text-left">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-100/50 border border-blue-200 text-blue-700 text-xs font-bold tracking-wide uppercase mb-8 mx-auto lg:mx-0 shadow-sm backdrop-blur-sm">
            ...
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight mb-6">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">Kinerja Utama</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="group relative px-8 py-4 bg-blue-600 text-white font-bold rounded-2xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3 w-full sm:w-auto overflow-hidden">
                            <span class="relative z-10 flex items-center gap-2">
                                Akses Dashboard
                                <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
                            </span>
                            <div class="absolute inset-0 bg-gradient-to-r from-blue-600 to-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity z-0"></div>
                        </a>
                    @else
        ...
        <div class="flex-1 relative w-full max-w-lg lg:max-w-none perspective-1000">
            <div class="relative bg-white/60 backdrop-blur-xl border border-white p-2 rounded-3xl shadow-2xl transform rotate-1 lg:rotate-2 hover:rotate-0 transition-transform duration-500">
                <div class="absolute inset-0 bg-gradient-to-tr from-blue-100/50 to-transparent rounded-3xl"></div>
