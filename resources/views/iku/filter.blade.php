                            ...
                            @forelse($ikus as $index => $iku)
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-sm text-right text-gray-600">
                                        {{ number_format($iku->jumlah, 2) }}</td>
                                    <td class="px-6 py-4 text-sm text-right">
                                        @if($iku->persentase_capaian !== null)
                                            <span
                                                class="text-green-600 font-semibold">{{ number_format($iku->persentase_capaian, 2) }}%</span>
                                        @else
                                    ...
                                    <td class="px-6 py-4 text-sm text-center">
                                        <div class="flex justify-center space-x-2">
                                            <a href="{{ route('user.iku.edit', $iku) }}"
                                            ...
                                            <form action="{{ route('user.iku.destroy', $iku) }}" method="POST"
